...
import type { ExternalBlob as _ExternalBlob, UserProfile as _UserProfile, UserRole as _UserRole, VideoJob as _VideoJob, VideoJobStatus as _VideoJobStatus, _CaffeineStorageRefillInformation as __CaffeineStorageRefillInformation, _CaffeineStorageRefillResult as __CaffeineStorageRefillResult } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async addPublicVideo(arg0: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.addPublicVideo(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async completeVideoJob(arg0: string, arg1: string, arg2: Variant_completed_failed): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.completeVideoJob(arg0, arg1, to_candid_variant_n10(this._uploadFile, this._downloadFile, arg2));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async createVideoJob(arg0: string, arg1: string, arg2: bigint, arg3: string, arg4: ExternalBlob | null): Promise<string> {
        if (this.processError) {
            try {
                const result = await this.actor.createVideoJob(arg0, arg1, arg2, arg3, await to_candid_opt_n11(this._uploadFile, this._downloadFile, arg4));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async deleteVideoJob(arg0: string): Promise<void> {
        if (this.processError) {
            try {
    ...
    async getMyVideoJobs(): Promise<Array<VideoJob>> {
        if (this.processError) {
            try {
                const result = await this.actor.getMyVideoJobs();
    ...
    async getPublicVideos(): Promise<Array<VideoJob>> {
        if (this.processError) {
            try {
                const result = await this.actor.getPublicVideos();
                return from_candid_vec_n16(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getVideoJob(arg0: string): Promise<VideoJob> {
        if (this.processError) {
            try {
                const result = await this.actor.getVideoJob(arg0);
                return from_candid_VideoJob_n17(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
            }
...
function from_candid_VideoJobStatus_n19(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _VideoJobStatus): VideoJobStatus {
    return from_candid_variant_n20(_uploadFile, _downloadFile, value);
}
async function from_candid_VideoJob_n17(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _VideoJob): Promise<VideoJob> {
...
async function from_candid_record_n18(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        id: value.id,
        status: from_candid_VideoJobStatus_n19(_uploadFile, _downloadFile, value.status),
        duration: value.duration,
        thumbnail: record_opt_to_undefined(await from_candid_opt_n21(_uploadFile, _downloadFile, value.thumbnail)),
        owner: value.owner,
        quality: value.quality,
        createdAt: value.createdAt,
        resultUrl: record_opt_to_undefined(from_candid_opt_n23(_uploadFile, _downloadFile, value.resultUrl)),
...
function from_candid_variant_n20(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return "pending" in value ? VideoJobStatus.pending : "completed" in value ? VideoJobStatus.completed : "processing" in value ? VideoJobStatus.processing : "failed" in value ? VideoJobStatus.failed : value;
}
async function from_candid_vec_n16(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_VideoJob>): Promise<Array<VideoJob>> {
    return await Promise.all(value.map(async (x)=>await from_candid_VideoJob_n17(_uploadFile, _downloadFile, x)));
}
...
function to_candid_variant_n10(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Variant_completed_failed): {
    completed: null;
} | {
    failed: null;
} {
    return value == Variant_completed_failed.completed ? {
        completed: null
    } : value == Variant_completed_failed.failed ? {
        failed: null
    } : value;
}
